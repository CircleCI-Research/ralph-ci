...
**Test Location**: Tests live in `experiments/no-ci_vs_ci/claude-default/no-ci-iteration-3/src/game.test.ts`
...
```
experiments/no-ci_vs_ci/claude-default/no-ci-iteration-3/
