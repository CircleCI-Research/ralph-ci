...
**Test Location**: Tests live in `experiments/no-ci_vs_ci/claude-default/ci-iteration-4/src/game.test.ts`
...
```
experiments/no-ci_vs_ci/claude-default/ci-iteration-4/
